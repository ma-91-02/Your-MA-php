...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" >
    ...
    <!-- End Header -->
      ...
      <div class="container">
        <div class="text">
          <h1 class="title">كورس الواجهة الامامية و الواجهة الخلفية Full Stack </h1><br/>
          <p><a href="https://docs.google.com/forms/d/e/1FAIpQLScU2LVrle_xhi40wfdOzEMe17Tn2__RKPcvoyWBUEJo0f2y-Q/viewform"> التسجيل</a>سوف تتعلم كيفية انشاء مواقع ويب وتطبيقات ويب كاملة من البداية الى الاحتراف بمبلغ 1400 دولار </p>
        </div>
        <div class="image">
        ...
        <div class="info">
          ...
          <div class="box">
            <div class="text text-start">
              <h3>الدعم </h3>
              <p>
              عالم البرمجة هو عالم سريع التطور و لهذا سوف نوفر لكم ندوات دعم فني نقدم من خلالها احدث التقنيات و طرق استخدامها مقابل خصومات كبيرة لطلابنا              </p>
            </div>
          </div>
          <div class="box">
            <div class="text text-start">
        ...
        <div class="box passion">
          ...
          <h2>مختصصو تكنولوجيا المعلومات</h2>
            ...
            <ul class="unstyle">
              ...
              <li>لمن يريد تعلم لغة البرمجة Node.js & PHP ويريد تعلّم إطار العمل Laravel </li>
    ...
    <h2 class="main-title"> مسار كورس الواجهة الامامية و الواجهة الخلفية Full Stack </h2>
    ...
    <div class="program">
        ...
        <div class="accordion" id="accordionExample">
              <div class="accordion-item">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#knowledge" aria-expanded="false" aria-controls="knowledge">
                      المعرفة العامة في نظام التشغيل [ OS and General Knowledge ]
                    </button>
                    </h2>
                    <div id="knowledge" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div class="row">
                    <div class="col">
                    <ul class="unstyled">
                        ...
                        <li>Basic Newtorking Concepts</li>
                        <li>Terminal Usage</li>
                        <li>How OSs work in General</li>
                        <li>Process Management</li>
                        <li>Threads and Concurrency</li>
                        <li>Basic Terminal Commands[ grep, awk, sed, losf, curl, wget, kill ....]</li>
                      </ul>
                    </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#Language" aria-expanded="false" aria-controls="Language">
                    تعلم لغة البرمجة [ Learn a programming Language ]
                    </button>
                    </h2>
                    <div id="Language" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div class="row">
                    <div class="col">
                    <ul class="unstyled">
                        <li>PHP basic level</li>
                        <li>PHP advanced level</li>
                        <li>OOP PHP</li>
                        <li>Framework Laravel basic</li>
                        <li>Framework Laravel advanced</li>
                        <li>JavaScript basic level</li>
                        <li>JavaScript advance level</li>
                        <li>Node.js</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#Databases" aria-expanded="false" aria-controls="Databases">
                    قواعد البيانات  [ Databases ]
                    </button>
                    </h2>
                    <div id="Databases" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div class="row">
                    <div class="col">
                    <ul class="unstyled">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed text-start" type="button" data-bs-toggle="collapse" data-bs-target="#APIs" aria-expanded="false" aria-controls="APIs">
                    التعرف على APIs 
                    </button>
                    </h2>
                    <div id="APIs" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div class="row">
                    <div class="col">
                    <ul class="unstyled">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#Caching" aria-expanded="false" aria-controls="Caching">
                     التخزين المؤقت [ Caching ] 
                    </button>
                    </h2>
                    <div id="Caching" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div>
                    <ul class="unstyled">
                      <li>CDN</li>
                ...
                <div class="accordion-item">
                    ...
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#Security" aria-expanded="false" aria-controls="Security">
                     معرفة امان الويب [ Web Security Knowledge ]
                    </button>
                    </h2>
                    <div id="Security" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div>
                    <ul class="unstyled">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#Unit" aria-expanded="false" aria-controls="Unit">
                     الاختبارات [ Testing ] 
                    </button>
                    </h2>
                    <div id="Unit" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div>
                    <ul class="unstyled">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#ci" aria-expanded="false" aria-controls="ci">
                      CI/CD 
                    </button>
                    </h2>
                    <div id="ci" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div>
                    <ul class="unstyled">
                      <li>في هندسة البرمجيات، تشير CI/CD أو CICD بشكل عام إلى الممارسات المشتركة للتكامل المستمر والتسليم المستمر أو النشرالمستمر. ويجسّد CI/CD الفجوات بين أنشطة التطوير والتشغيل والفرق من خلال فرض التشغيل الآلي في بناء التطبيقات واختبارها ونشرها</li>
                    </ul>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#principles" aria-expanded="false" aria-controls="principles">
                     مبادئ التصميم والتطوير [ Design and Development Principles ] 
                    </button>
                    </h2>
                    <div id="principles" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div>
                    <ul class="unstyled">
                      <li>SOLID</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#patterns" aria-expanded="false" aria-controls="patterns">
                      الانماط المعمارية[ Architectural Patterns ]
                    </button>
                    </h2>
                    <div id="patterns" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div>
                    <ul class="unstyled">
                      <li>Nonolithic Apps</li>
                      <li>Microservices</li>
                      <li>SOA</li>
                      <li>Serveriess</li>
                    </ul>
                ...
                <div class="accordion-item">
                    ...
                    <div id="search" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div>
                    <ul class="unstyled">
                      <li>Elasticsearch هو محرك بحث وتحليلات موزع ومجاني ومفتوح لجميع أنواع البيانات</li>
                    </ul>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#message" aria-expanded="false" aria-controls="message">
                     وسيط رسائل [ Message Brokers ] 
                    </button>
                    </h2>
                    <div id="message" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div>
                    <ul class="unstyled">
                      <li>RabbitMQ هو وسيط رسائل مفتوح المصدر وخادم قائمة الانتظار ، يستخدم لمشاركة البيانات بين التطبيقات المختلفة تمامًا من خلال البروتوكولات الشائعة. RabbitMQ مكتوب بلغة Erlang ، ويستند RabbitMQ إلى بروتوكول AMQP.</li>
                    </ul>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#docker" aria-expanded="false" aria-controls="docker">
                      الحاويات [ Containerization ]
                    </button>
                    </h2>
                    <div id="docker" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    </div>
                    <ul class="unstyled">
                      <li>دوكر (Docker) هي أداة مُوجَّهةٌ لمُدراءِ الأنظمة والمطورين تستخدم في عمليات بناء ( Build ) وتشغيل البرامج ضمن بيئة معينة عبر تشغيل المشروع بداخل حاويات دوكر ( Docker Containers )، مما يسهل عملية نقل المشروع من جهاز إلى جهاز آخر دون الحاجة لتعديل إعدادات ومتغيرات النظام، أو تنصيب أو تحميل حزم معينة، حيث يتم فقط تنصيب دوكر وتشغيل الحاويات المُعدة مسبقا بإعدادات معينة تسمح بتشغيل التطبيق ضمن هذه الحاويات.</li>
                    </ul>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#wp" aria-expanded="false" aria-controls="wp">
                      تطوير قوالب ووردبريس 
                    </button>
                    </h2>
                    <div id="wp" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
        ...
        <div class="container">
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item">
                    ...
                    <div id="three" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    <p> تطوير نظام إدارة محتوى يتيح إضافة منشورات وصفحات وإدارة المستخدمين من الصفر باستخدام Laravel 
                    </p>
                    </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                      ...
                      <p>إنشاء متاجر إلكتروني عبر ووكومرس WooCommerce وتطوير قوالبه وإضافاته </p>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
